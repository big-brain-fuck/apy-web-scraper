...
async def get_mongo_db() -> AsyncCollection[Mapping[str, Any] | Any]:
    mongo_db_collection = 'news'
    client = pymongo.AsyncMongoClient('mongodb://uherqroowf4y8a9ukuyo:Mu4zb3U80pWnWeyxjBO@bpxrfduhgta5alqf36jg-mongodb.services.clever-cloud.com:2710/bpxrfduhgta5alqf36jg')
    return client['bpxrfduhgta5alqf36jg'][mongo_db_collection]
